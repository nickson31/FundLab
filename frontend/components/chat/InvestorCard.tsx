            ...
            <div className="flex flex-col h-full">
                ...
                <div className="p-8 space-y-8">
                    ...
                    {smartData?.unique_highlight ? (
                        <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-indigo-50 to-violet-50 dark:from-indigo-900/20 dark:to-violet-900/20 p-5 border border-indigo-100 dark:border-indigo-900/30">
                            <div className="absolute top-0 right-0 p-3 opacity-10">
                                <Zap className="w-12 h-12 text-indigo-500" />
                            </div>
                            <div className="relative z-10">
                                <span className="inline-flex items-center gap-1.5 px-2 py-1 rounded-md bg-white/60 dark:bg-black/20 text-[10px] font-bold text-indigo-600 uppercase tracking-wider mb-2">
                                    <Sparkles className="w-3 h-3" /> Investor Spotlight
                                </span>
                                <p className="text-lg font-bold text-indigo-950 dark:text-indigo-100 leading-snug">
                                    {smartData.unique_highlight}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="p-4 rounded-xl bg-indigo-50/50 dark:bg-white/5 border border-indigo-100">
                            <span className="text-xs font-bold text-indigo-400 uppercase tracking-wider">Note</span>
                ...
                >
                    {isExpanded ? "Close Deep Dive" : "View Details & Insights"}
                        ...
                        >
                            <div className="p-8 space-y-8">
                                ...
                                <div className="space-y-2">
                                    <h4 className="text-xs font-bold text-indigo-400 uppercase tracking-widest">Investment Logic</h4>
