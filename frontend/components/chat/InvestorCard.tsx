...
export default function InvestorCard({
    ...
    return (
        ...
        >
            ...
            <div className="hidden dark:block absolute inset-0 bg-gradient-to-tr from-indigo-500/5 via-purple-500/5 to-pink-500/5 rounded-3xl opacity-0 group-hover:opacity-100 transition-all duration-700 blur-xl" />

            {/* Main Card - Solid White (Light) / Glass (Dark) */}
            <div className="relative bg-white dark:bg-black/40 dark:backdrop-blur-3xl border border-gray-300 dark:border-white/10 rounded-2xl p-6 shadow-xl dark:shadow-none hover:shadow-2xl transition-all duration-500 overflow-hidden">
