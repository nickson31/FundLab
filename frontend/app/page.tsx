...
export default function Home() {
  return (
    ...
    <div className="min-h-screen bg-white dark:bg-black text-indigo-950 dark:text-white selection:bg-indigo-500/30 selection:text-indigo-200">
      ...
      {/* Intelligence at Scale (Light Mode Friendly) */}
      <section className="py-24 bg-slate-50 dark:bg-black relative border-t border-indigo-50 dark:border-white/10">
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {/* Card 1 */}
            <div className="bg-white dark:bg-[#0f0f0f] border border-indigo-100 dark:border-white/10 rounded-2xl p-8 shadow-xl shadow-indigo-500/5 hover:border-indigo-500/50 transition-colors">
              <div className="w-12 h-12 bg-indigo-50 dark:bg-indigo-900/20 rounded-xl flex items-center justify-center text-indigo-600 dark:text-indigo-400 mb-6 border border-indigo-100 dark:border-indigo-500/20">
            ...
            {/* Card 2 */}
            <div className="bg-white dark:bg-[#0f0f0f] border border-indigo-100 dark:border-white/10 rounded-2xl p-8 shadow-xl shadow-indigo-500/5 hover:border-purple-500/50 transition-colors">
              <div className="w-12 h-12 bg-purple-50 dark:bg-purple-900/20 rounded-xl flex items-center justify-center text-purple-600 dark:text-purple-400 mb-6 border border-purple-100 dark:border-purple-500/20">
            ...
            {/* Card 3 */}
            <div className="bg-white dark:bg-[#0f0f0f] border border-indigo-100 dark:border-white/10 rounded-2xl p-8 shadow-xl shadow-indigo-500/5 hover:border-emerald-500/50 transition-colors">
              <div className="w-12 h-12 bg-emerald-50 dark:bg-emerald-900/20 rounded-xl flex items-center justify-center text-emerald-600 dark:text-emerald-400 mb-6 border border-emerald-100 dark:border-emerald-500/20">
      ...
      {/* BUILT FOR EVERY STAGE (Light Mode Friendly) */}
      <section className="py-24 bg-white dark:bg-black border-t border-indigo-50 dark:border-white/10">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-7xl mx-auto">
            {/* Card 1: PRE-SEED */}
            <div className="rounded-2xl border border-emerald-100 dark:border-emerald-900/50 bg-slate-50 dark:bg-[#0A0A0A] p-8 hover:border-emerald-500/50 transition-all duration-300 group shadow-sm">
            ...
            {/* Card 2: SEED */}
            <div className="rounded-2xl border border-indigo-100 dark:border-indigo-900/50 bg-slate-50 dark:bg-[#0A0A0A] p-8 hover:border-indigo-500/50 transition-all duration-300 group shadow-sm">
              <div className="flex justify-between items-center mb-6">
            ...
            {/* Card 3: SERIES A+ */}
            <div className="rounded-2xl border border-orange-100 dark:border-orange-900/50 bg-slate-50 dark:bg-[#0A0A0A] p-8 hover:border-orange-500/50 transition-all duration-300 group shadow-sm">
              <div className="flex justify-between items-center mb-6">
      ...
      {/* CTA Section - Redesigned for High Conversion & Premium Feel */}
      <section className="py-32 relative overflow-hidden bg-gradient-to-br from-indigo-50 to-white dark:from-black dark:to-indigo-950/20 border-t border-indigo-100 dark:border-white/10">
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="inline-block p-1 rounded-full bg-indigo-100/50 dark:bg-white/5 border border-indigo-200 dark:border-white/10 mb-6">
          ...
          <h2 className="text-5xl md:text-7xl font-black text-indigo-950 dark:text-white mb-8 tracking-tighter">
            Fundraise with <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600">Superhuman Speed.</span>
          </h2>
          <p className="text-xl md:text-2xl text-indigo-900/70 dark:text-indigo-200/60 max-w-2xl mx-auto mb-12 leading-relaxed font-medium">
